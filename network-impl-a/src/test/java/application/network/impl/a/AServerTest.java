...
import application.network.impl.a.server.AServerConnection;
...
public class AServerTest
{
    ...
    {
        BiFunction<Socket, AServer, AServerConnection> mockFactory = mock(BiFunction.class);
        server = new AServer(mockFactory);
        server.listen(50000);
